...
namespace engine
{
	...
	export class LVec3
	{
		...
		public static sum( v1 : LVec3, v2 : LVec3 ) : LVec3
		{
	...
	export class LMat4
	{
		...
		public static rotationX( ang : number ) : LMat4
		{
			...
			_res.buff[0] = 1; _res.buff[1] =  0; _res.buff[2]  = 0;
			_res.buff[4] = 0; _res.buff[5] = _c; _res.buff[6]  = -_s;
			_res.buff[8] = 0; _res.buff[9] = _s; _res.buff[10] = _c;
		...
		public static rotationY( ang : number ) : LMat4
		{
			...
			_res.buff[0] = _c;  _res.buff[1] = 0; _res.buff[2]  = _s;
			_res.buff[4] =  0;  _res.buff[5] = 1; _res.buff[6]  =  0;
			_res.buff[8] = -_s; _res.buff[9] = 0; _res.buff[10] = _c;
		...
		public static rotationZ( ang : number ) : LMat4
		{
			...
			_res.buff[0] = _c; _res.buff[1] = -_s; _res.buff[2]  = 0;
			_res.buff[4] = _s; _res.buff[5] = _c;  _res.buff[6]  = 0;
			_res.buff[8] =  0; _res.buff[9] =  0;  _res.buff[10] = 1;
		...
		public static scale( sx : number, sy : number, sz : number ) : LMat4
		{
			...
			_res.buff[0] = sx; _res.buff[1] =  0;  _res.buff[2]  =  0;
			_res.buff[4] =  0; _res.buff[5] = sy;  _res.buff[6]  =  0;
			_res.buff[8] =  0; _res.buff[9] =  0;  _res.buff[10] = sz;
		...
		public static perspective( fov : number, aspect : number, zNear : number, zFar : number ) : LMat4
		{
			...
			_res.buff[0]  = 1 / ( _ht * aspect )  ; _res.buff[1]  =   0		; _res.buff[2]  = 		  			0					   ; _res.buff[3]  =  0;
			_res.buff[4]  = 		0			  ; _res.buff[5]  = 1 / _ht	; _res.buff[6]  = 		  			0					   ; _res.buff[7]  =  0;
			_res.buff[8]  = 		0			  ; _res.buff[9]  =   0		; _res.buff[10] = -( zFar + zNear ) / ( zFar - zNear )	   ; _res.buff[11] = -1;
			_res.buff[12] = 		0			  ; _res.buff[13] =   0		; _res.buff[14] = -2 * ( zFar * zNear ) / ( zFar - zNear ) ; _res.buff[15] =  0;		
