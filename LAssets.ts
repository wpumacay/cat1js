...
namespace assets
{
    ...
    [
        new core.LModelInfo( 'base_link',
                             'res/models/base_link.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_1',
                             'res/models/link_1.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_2',
                             'res/models/link_2.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_3',
                             'res/models/link_3.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_4',
                             'res/models/link_4.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_5',
                             'res/models/link_5.dae',
                             core.MODEL_TYPE_COLLADA ),
        new core.LModelInfo( 'link_6',
    ...
    [
        new core.LTextAssetInfo( 'kr210_urdf',
                                 'res/text/kr210.urdf' )
    ];
}
