...
namespace engine3d
{
    ...
    export class LShaderSimpleTexture extends core.LShader
    {
        ...
        constructor( obj : WebGLProgram )
        {
            ...
            this.m_uTexture = gl.getUniformLocation( obj, "u_texture" );
        ...
        public setTexture( texture : core.LTexture ) : void
        {
